...
public class ArchivedTableData {
    private int empId1;
    private String fullname1, phoneNumber1, joinedDate1, address1, designation1, status1, salary1;
    private CheckBox restoreButton;

    public ArchivedTableData(int empId1, String fullname1, String phoneNumber1, String address1, String joinedDate1, String designation1, String status1, String salary1, CheckBox restoreButton) {
        this.empId1 = empId1;
